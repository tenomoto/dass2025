...
配布プログラムはgfortran-14.2.0でコンパイル、実行ができることを確認した。
...
複数のバージョンを共存させるために、Pythonのライブラリ名はpy313-numpyのようにPythonのバージョンが付されている。
`python313`は`/opt/local/Library/Frameworks/Python.framework/Versions/3.13`にインストールされる。
