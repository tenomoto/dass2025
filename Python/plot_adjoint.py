...
fig, ax = plt.subplots(figsize=fig_size)
ax.plot(par[:, 0], label="a1", lw=2) # R's a1 is at index 0
...
# Plot 5: y parameters (a4, a5, a6) vs. Iteration
fig, ax = plt.subplots(figsize=fig_size)
ax.plot(par[:, 3], label="a4", lw=2) # R's a4 is at index 3
